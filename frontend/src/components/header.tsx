...
const Header = () => {
    ...
    return (
        <Navbar className="w-full max-w-7xl mx-auto dark:bg-black">
            ...
            <div className="md:order-2 flex flex-row items-center gap-10 text-center">
                ...
                {currentUser ? (
                    <Dropdown arrowIcon={false} inline label={ // inline to make the image as the source for Dropdown
                        ...
                        <Dropdown.Divider />
                        <Dropdown.Item className="text-xs">Sign out</Dropdown.Item>
            ...
            <Navbar.Collapse className="text-center font-medium">
                ...
                <Navbar.Link active={location.pathname == "/blogs" ? true : false} as={Link} to="/blog">All blogs</Navbar.Link>
                <Navbar.Link as={Link} to="">Contact</Navbar.Link>
                <Navbar.Link as={Link} to="">Jingle</Navbar.Link>
            </Navbar.Collapse>
