...
const FooterComponent = () => {
    return (
        <Footer container className="border-t-red-400 dark:bg-gray-950 dark:text-white text-black border-t-[6px]">
            <div className="flex flex-col gap-10 w-full">
                <main className="flex flex-col items-center gap-10 md:gap-0 md:items-center md:flex-row md:justify-around w-full">
                    <div className="flex flex-col gap-6">
                        ...
                        <span className="flex flex-col gap-6 md:items-start items-center dark:text-gray-300 text-gray-600 text-sm">
                ...
                <hr />
                <span className="text-xs text-gray-400 text-center">&copy; {new Date().getFullYear()} Prajwal Gowda G. All rights reserved</span>
